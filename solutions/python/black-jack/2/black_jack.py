...
def higher_card(card_one, card_two):
    ...
    elif val_card_two > val_card_one:
...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    ace_present = (card_one == "A") or (card_two == "A")
    ten_card_present = (card_one in ["J", "Q", "K", "10"]) or (card_two in ["J", "Q", "K", "10"])
    return ace_present and ten_card_present
...
def can_split_pairs(card_one, card_two):
    ...
    """
    return bool(value_of_card(card_one) is value_of_card(card_two))
...
def can_double_down(card_one, card_two):
    ...
    return bool(total_value in [9, 10, 11])